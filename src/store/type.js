...
export const IS_SUCCESS_SERVICES = "IS_SUCCESS_SERVICES";
export const CLEAR_ALERT_SERVICES = "CLEAR_ALERT_SERVICES";
...
export const IS_SUCCESS_STAFFS = "IS_SUCCESS_STAFFS";
export const CLEAR_ALERT_STAFFS = "CLEAR_ALERT_STAFFS";
